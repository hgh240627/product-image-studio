...
if (!/imageBaseUrl: isPresetProvider && Object\.prototype\.hasOwnProperty\.call\(preset, "baseUrl"\) \? preset\.baseUrl/.test(rendererSource)) {
  errors.push("前端保存/检测内置作图供应商时没有强制使用预设 API 地址。");
}
...
if (!rendererSource.includes('$("#grsaiBaseUrl").value = isPresetImageProvider && Object.prototype.hasOwnProperty.call(imagePreset, "baseUrl") ? imagePreset.baseUrl')) {
  errors.push("打开设置页时没有按当前内置作图供应商刷新 API 地址。");
}
